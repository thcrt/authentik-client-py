...
google_workspace_provider_mapping_request_form_dict = google_workspace_provider_mapping_request.from_dict(google_workspace_provider_mapping_request_dict)
```
