...
> GroupKerberosSourceConnection sources_group_connections_kerberos_partial_update(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_kerberos_partial_update(id)
...
> GroupKerberosSourceConnection sources_group_connections_kerberos_update(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_kerberos_update(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_oauth_create()
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_oauth_partial_update(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_oauth_update(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_plex_create()
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_plex_partial_update(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_plex_update(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_saml_partial_update(id)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_group_connections_saml_update(id)
...
> PaginatedKerberosSourceList sources_kerberos_list(enabled=enabled, name=name, ordering=ordering, page=page, page_size=page_size, password_login_update_internal_password=password_login_update_internal_password, realm=realm, search=search, slug=slug, spnego_server_name=spnego_server_name, sync_principal=sync_principal, sync_users=sync_users, sync_users_password=sync_users_password)
...
with authentik_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.sources_kerberos_list(enabled=enabled, name=name, ordering=ordering, page=page, page_size=page_size, password_login_update_internal_password=password_login_update_internal_password, realm=realm, search=search, slug=slug, spnego_server_name=spnego_server_name, sync_principal=sync_principal, sync_users=sync_users, sync_users_password=sync_users_password)
