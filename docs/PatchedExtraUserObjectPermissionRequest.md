...
patched_extra_user_object_permission_request_form_dict = patched_extra_user_object_permission_request.from_dict(patched_extra_user_object_permission_request_dict)
```
