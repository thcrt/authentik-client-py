...
> [!CAUTION]
> **This isn't an official authentik repository. You shouldn't use it.**
>
> I created this repository to upload a copy of the documentation for the authentik Python client, [`authentik-client`](https://pypi.org/project/authentik-client), which is otherwise hard to find.
> While it was accurate at the time I uploaded it, I can't guarantee that it's still accurate to the latest versions of either authentik or `authentik-client`.
> 
> I've reported the inaccessibility of the documentation to authentik themselves in [`goauthentik/authentik#12170`](https://github.com/goauthentik/authentik/issues/12170), and hopefully they will eventually publish documentation themselves.
>
> If you have any issues with authentik or `authentik-client`, you should report them to the main authentik repository, [`goauthentik/authentik`](https://github.com/goauthentik/authentik). I'm not an authentik contributor or maintainer and I won't be able to help you. Sorry.
...
- Package version: 2024.10.4-1733147010
...
*AuthenticatorsApi* | [**authenticator](https://github.com/goauthentik/authentik/issues/12170)s_admin_duo_destroy**](docs/AuthenticatorsApi.md#authenticators_admin_duo_destroy) | **DELETE** /authenticators/admin/duo/{id}/ | 
...
*AuthenticatorsApi* | [**authenticators_sms_update**](docs/AuthenticatorsApi.md#authenticators_sms_update) | **PUT** /auhttps://github.com/goauthentik/authentik/issues/12170thenticators/sms/{id}/ | 
...
*CoreApi* | [**core_applications_partial_update**](docs/CoreApi.md#core_applications_pahttps://github.com/goauthentik/authentik/issues/12170rtial_update) | **PATCH** /core/applications/{slug}/ | 
...
*FlowsApi* | [**flows_instances_import_create**](docs/FlowsApi.md#flows_instances](https://github.com/goauthentik/authentik/issues/12170)_import_create) | **POST** /flows/instances/import/ | 
